...
# ##########################################
os.chdir(r"C:\Users\samuel.dressler\Desktop\Kmeans\Museum Clustering Tryouts\csv")
...
extract_temperature("0012_MWIR (2).csv")
...
def extract_temperature(csv_filename):
    ...
    with open(csv_filename) as csv_file:
        csv_file_content = pd.read_csv(csv_filename)

        csv_file_content_1 = csv_file_content[9:]
        print("1:", csv_file_content_1)
